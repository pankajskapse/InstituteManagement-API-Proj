<%@ Page Title="Sub-Course" Language="C#" MasterPageFile="~/MasterPage/Standard.Master" AutoEventWireup="true" CodeBehind="SubcoursePage.aspx.cs" Inherits="InstituteManagement.Admin.SubcoursePage" %>
            ...
            <div class="col-xs-6 col-sm-12 col-md-6 col-lg-6">
                ...
                <div class="row divBottomMargin">
                    <div class="col-xs-6 col-sm-12 col-md-4 col-lg-5">
                        ...
                        <asp:TextBox ID="txtSubCourseKeyForEditMode" runat="server" Visible="false"></asp:TextBox>
                    </div>
                    <div class="col-xs-6 col-sm-12 col-md-8 col-lg-7">
                        <asp:TextBox ID="txt_SubCourse" runat="server" Width="100%"></asp:TextBox>
                    </div>
                </div>
                <div class="row divBottomMargin">
                    <div class="col-xs-6 col-sm-12 col-md-4 col-lg-5">
                        <asp:Label ID="labSubCourseDesc" runat="server" Text="Sub-Course Desc.:*"></asp:Label>
                    </div>
                    <div class="col-xs-6 col-sm-12 col-md-8 col-lg-7">
                        <asp:TextBox ID="txt_SubCourseDesc" runat="server" Width="100%"></asp:TextBox>
                    </div>
                </div>
                <div class="row divBottomMargin">
                    <div class="col-xs-6 col-sm-12 col-md-4 col-lg-5">
            ...
            <div class="col-xs-6 col-sm-12 col-md-6 col-lg-6">
                <div class="row divBottomMargin">
                    <div class="col-xs-6 col-sm-12 col-md-4 col-lg-3">
                        <asp:Label ID="Label1" runat="server" Text="Sub-Course Code"></asp:Label>
                    </div>
                    <div class="col-xs-6 col-sm-12 col-md-8 col-lg-4">
                        <asp:TextBox ID="txtSubCourseCodeSearch" runat="server" Width="100%"></asp:TextBox>
                    </div>
                ...
                <div class="row divBottomMargin" style="overflow: auto">
                    <asp:GridView ID="grdSubCourse" runat="server" ForeColor="Black" BorderStyle="solid" Width="100%"
                        CssClass="col" BorderColor="#999999" BackColor="White" GridLines="Both" CellPadding="4" Height="100px"
                        BorderWidth="1px" AutoGenerateColumns="false" AllowSorting="True" CellSpacing="0" AllowPaging="true" PageSize="6"
                        EnablePersistedSelection="True" DataKeyNames="subcourseKey" ViewStateMode="Enabled" OnSelectedIndexChanged="grdSubCourse_SelectedIndexChanged"
                        AutoGenerateSelectButton="true" OnPageIndexChanging="grdSubCourse_PageIndexChanging">
                        ...
                        <Columns>
                            ...
                            <asp:BoundField DataField="subcourseDesc" HeaderText="SubCourse Desc" />
                            ...
                            <asp:BoundField DataField="courseDesc" HeaderText="course Desc" />
